  ...
  return (
    <div className="bg-white rounded-xl p-8 h-fit relative shadow-sm">
      <div className="flex items-start sm:items-center flex-col sm:flex-row">
        <h1 className="text-xl sm:text-3xl lg:text-4xl text-slate-600 font-bold me-4">About</h1>
      ...
      <h2 className="text-slate-600 font-medium text-lg sm:text-2xl mt-4">What I Do!</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 text-slate-600 h-fit">
        <div className="bg-rose-50 rounded-md p-4">
          <div className="flex flex-row items-center">
            ...
            <div>
              <h4 className="text-sm sm:text-base font-bold line-clamp-1">Web Development</h4>
        ...
        <div className="bg-blue-50 rounded-md p-4">
          ...
          <div className="flex flex-row items-center">
            ...
            <div>
              <h4 className="text-sm sm:text-base font-bold line-clamp-1">UI/UX Design</h4>
              <p className="text-slate-500 text-sm">Designing interfaces for web and mobile applications</p>
            </div>
          </div>
        </div>
        <div className="bg-blue-50 rounded-md p-4">
          ...
          <div className="flex flex-row items-center">
            ...
            <div>
              <h4 className="text-sm sm:text-base font-bold line-clamp-1">Backend Development</h4>
              <p className="text-slate-500 text-sm">Creating a RESTful API to be accessed by the frontend team</p>
            </div>
          </div>
        </div>
        <div className="bg-rose-50 rounded-md p-4">
          ...
          <div className="flex flex-row items-center">
            ...
            <div>
              <h4 className="text-sm sm:text-base font-bold line-clamp-1">Mobile Development</h4>
              <p className="text-slate-500 text-sm">
