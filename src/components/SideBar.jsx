...
function SideBar() {
  ...
  return (
    <div className="bg-white rounded-xl p-6 col-span-1 h-fit shadow-sm">
      <div className="grid grid-cols-1 gap-3">
        <div
          className={`aspect-square rounded-xl flex flex-col justify-center items-center cursor-pointer ${
            menu == "about" ? "bg-blue-500 text-white" : "bg-slate-100 hover:bg-slate-200"
          }`}
          onClick={() => handleMenu("about")}
        >
          <HiOutlineUser className="text-xl mb-2" />
        ...
        >
          <IoDocumentTextOutline className="text-xl mb-2" />
        ...
        >
          <MdWorkOutline className="text-xl mb-2" />
        ...
        >
          <MdOutlineWeb className="text-xl mb-2" />
        ...
        >
          <RiContactsBook3Line className="text-xl mb-2" />
